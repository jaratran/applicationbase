...
<div class="container app-page">
    <div class="app-page-header">
        <div>
            <h1 class="app-page-title">Sucursales</h1>
            <p class="app-page-description">Administre las unidades organizacionales y su ubicación.</p>
        </div>
        <div class="app-page-actions">
            <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('sucursal.create') }}'">
                <i class="fa fa-plus me-1" aria-hidden="true"></i>Nueva Sucursal
            </button>
        </div>
    </div>
    <div class="row">

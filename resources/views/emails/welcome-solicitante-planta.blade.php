                    ...
                    <tr>
                        <td>
                            ...
                            <h2 style="color: {{ $designParameter->custom_primary }};">
                                ¡Bienvenido/a a <strong>EcoRuta</strong> el Sistema de Planificación de Retiro de Materia Prima de <strong>La Portada</strong>!
                            </h2>

                            <p>Nos complace informarte que tu acceso ha sido habilitado exitosamente.<br>A partir de ahora, podrás solicitar y gestionar el retiro de materia prima de manera más eficiente, segura y organizada, directamente desde nuestra plataforma.</p>

                            <p><strong>¿Qué puedes hacer en el sistema?</strong></p>
                            <ul>
                                <li>Solicitar retiros de materia prima según tus necesidades operativas.</li>
                                <li>Consultar el historial y estado de tus solicitudes.</li>
                                <li>Ajustar tus solicitudes o cancelarlas si es necesario.</li>
                                <li>Coordinar con el equipo de logística de <strong>La Portada</strong> para asegurar un flujo oportuno de camiones.</li>
                            ...
                            <p>En La Portada estamos comprometidos en brindarte las mejores herramientas para optimizar tus procesos.</p>

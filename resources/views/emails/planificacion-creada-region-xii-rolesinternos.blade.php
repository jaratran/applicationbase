...
<head>
    <meta charset="UTF-8">
    <title>Planificación de Retiro - Region XII - Realizada</title>
</head>
                        ...
                        <td>
							...
							@switch($planificacion->tipo_operacion)
								@case(config('constantes.TIPO_OPERACION_RETIRO'))
									<p>Le informamos que se ha planificado el retiro de materia prima para la Región XII con el siguiente detalle:</p>
									@break

								@case(config('constantes.TIPO_OPERACION_REPOSICION'))
									<p>Le informamos que se ha planificado la reposición de bines para la Región XII con el siguiente detalle:</p>
									@break

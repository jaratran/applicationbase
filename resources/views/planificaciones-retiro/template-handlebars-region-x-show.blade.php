<script id="template-region-x-show-planificacion" type="text/x-handlebars-template">
    @verbatim
            ...
            <div class="bg-light border rounded p-3">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" value="{{planificacion.duracion_horas}}" disabled>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Hora estimada de llegada a Planta la Portada</label>
                        <input type="datetime-local" class="form-control" value="{{planificacion.hora_llegada_estimada_format}}" disabled>
                    </div>
                </div>
                <div class="row my-3">
                    <div class="form-group col-md-4">
                ...
                <div class="row my-3">
                    <div class="form-group col-md-4">
                        <label>Patente de Camión</label>
                        <input type="text" class="form-control" value="{{planificacion.camion.patente}}" disabled>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Patente de Rampla</label>
                        <input type="text" class="form-control" value="{{planificacion.patente_rampla}}" disabled>
                    </div>
                </div>
                <div class="row my-3">
                    <div class="form-group col-md-4">

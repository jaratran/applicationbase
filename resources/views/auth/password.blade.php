        ...
        <div class="col-md-4 p-4 text-center">
            <div class="card border-0 login-panel shadow rounded p-4">
                ...
                <div class="card-body">
                    ...
                    <form role="form" method="POST" action="{{ route('user.activate') }}">
                        ...
                        <div class="my-3 form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        ...
                        <div class="my-3 form-group">
                            <button type="submit" class="btn btn-primary w-100">
                                <i class="fa fa-btn fa-edit"></i> Defina Contraseña
                            </button>
                        </div>
                    </form>
